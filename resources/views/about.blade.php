...
@section('title', 'About Pathfinder311 – Independent Life Insurance & Financial Protection Specialist')
@section('meta_description', 'Pathfinder311 is an independent insurance agency committed to helping people navigate life insurance and financial protection with confidence.')
         ...
         <div class="row">
            <div class="col-xxl-12">
               <div class="breadcrumb__content text-center z-index">
                  <h3 class="breadcrumb__title">About Pathfinder311</h3>
         ...
         <div class="row justify-content-center">
            <div class="col-xl-9 col-lg-9">
               <div class="service__section-box text-center mb-50">
                  ...
                  Pathfinder311 exists to prevent these costly mistakes before they become serious financial problems.</p>
               </div>
            </div>
         </div>
         <div class="row">
