...
@section('title', 'Pathfinders527 LLC – Independent Life Insurance & Financial Protection Specialist')
                  ...
                  <div class="col-xxl-7 col-xl-8 col-lg-10">
                     <div class="slider__content-box z-index-5">
                        <div class="slider__title-box">
                           <h2 class="slider__title text-white pb-25">Pathfinders527 LLC – Financial Protection & Business Advisory</h2>
                           <p class="text-white pb-25">Pathfinders527 LLC helps individuals and small business owners protect profits, remain compliant, and build financially sound businesses through proper structure, accurate records, and strategic tax planning.</p>
                        </div>
                  ...
                  <div class="accordion-items wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
                     <h2 class="accordion-header" id="faqHeading6">
                        <button class="accordion-buttons collapsed" type="button" data-bs-toggle="collapse"
                           ...
                           <i class="fas fa-chart-line"></i> How is Pathfinders527 LLC different from a regular accountant or CPA?
                        </button>
                     </h2>
                  ...
                  <div class="accordion-items wow tpfadeUp" data-wow-duration=".7s" data-wow-delay="1s">
                     <h2 class="accordion-header" id="faqHeading7">
                        <button class="accordion-buttons collapsed" type="button" data-bs-toggle="collapse"
                           ...
                           <i class="fas fa-rocket"></i> How do I get started with Pathfinders527 LLC?
                        </button>
                     </h2>
...
<script>
   (function() {
      ...
      var overlay = function() {
         return document.getElementById(pid + '-overlay');
      };
      var box = function() {
         return document.getElementById(pid + '-div');
      };
      ...
      function wireButtons() {
         document.querySelectorAll('a[href="{{ route('
            contact ') }}"]:not([data-no-popup])').forEach(function(el) {
